 ...
 * @author Author
 */
public class PiglinHunterAnimations {
    public static final AnimationDefinition walk = AnimationDefinition.Builder.withLength(2.0F).looping()
            ...
            .addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(1.0F, KeyframeAnimations.degreeVec(-12.4539F, -1.0809F, 2.6179F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(2.0F, KeyframeAnimations.degreeVec(27.5F, 0.0F, 7.5F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            ...
            .addAnimation("left_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-20.0622F, -7.3846F, -11.0067F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.0F, KeyframeAnimations.degreeVec(21.5456F, -6.3338F, -3.5296F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(2.0F, KeyframeAnimations.degreeVec(-20.0622F, -7.3846F, -11.0067F), AnimationChannel.Interpolations.CATMULLROM)
            ))
    ...
    public static final AnimationDefinition walk_with_spear = AnimationDefinition.Builder.withLength(2.0F).looping()
            .addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(5.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.4583F, KeyframeAnimations.degreeVec(3.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.9167F, KeyframeAnimations.degreeVec(5.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
    ...
    public static final AnimationDefinition riding = AnimationDefinition.Builder.withLength(0.0F)
            .addAnimation("right_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-62.3815F, 4.2236F, 2.6961F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("left_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-59.4013F, -10.8036F, -6.3253F), AnimationChannel.Interpolations.LINEAR)
            ))
            .build();
}