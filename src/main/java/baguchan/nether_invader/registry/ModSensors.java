...
import baguchan.nether_invader.entity.sensor.PiglinWarriorSpecificSensor;
...
public class ModSensors {
    ...
    public static final DeferredHolder<SensorType<?>, SensorType<PiglinWarriorSpecificSensor>> PIGLIN_WARRIOR_SENSOR = SENSOR_TYPE.register("piglin_warrior", (properties) -> new SensorType<>(PiglinWarriorSpecificSensor::new));
