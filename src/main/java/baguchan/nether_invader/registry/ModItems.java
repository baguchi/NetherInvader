...
public class ModItems {
    ...
    public static final DeferredItem<SpawnEggItem> PIGLIN_HUNTER_SPAWN_EGG = ITEMS.registerItem("piglin_hunter_spawn_egg", (properties) -> new SpawnEggItem((properties.spawnEgg(ModEntities.PIGLIN_HUNTER.get()))));
